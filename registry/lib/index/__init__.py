...
def load_service():
    from . import models
    return models.SQLAlchemyService()

def load_recommend():
    from . import models
    return models.SQLAlchemyRecommend()

def load_category():
    from . import models
    return models.SQLAlchemyCategory()

def load_banner():
    from . import models
    return models.SQLAlchemyBanner()
