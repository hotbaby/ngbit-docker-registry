...
@app.route('/v1/services/recommends', methods=['GET'])
def get_service_recommends():
...
def post_service_info(service_id):
    data = None
    logger.debug('request data: {0}'.format(flask.request.data))
    try:
